...
import 'package:map_manager/manager/map_exceptions.dart';
...
class MapMode with _$MapMode {
  ...
  factory MapMode.tracking({
    ...
    @Default(DisplayMode.showAll) DisplayMode displayMode,
  }) = TrackingMode;
